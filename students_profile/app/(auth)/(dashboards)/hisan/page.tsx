// src/app/(dashboards)/hisan/page.tsx
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold text-[#004643]">HISAN Control Center</h1>
          <p className="text-gray-500 mt-1">Manage events, track participation, and declare winners.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border border-blue-100 bg-blue-50/50 rounded-xl">
              <div className="flex justify-between">
                <h3 className="font-bold text-gray-800">Urdu Essay Competition</h3>
                <span className="text-xs bg-blue-100 text-blue-800 font-bold px-2 py-1 rounded">Sub-Wing</span>
              </div>
              <p className="text-sm text-gray-500 mt-2">45 Participants Registered</p>
              <button className="mt-3 text-sm font-bold text-blue-600 hover:text-blue-800">Manage Event →</button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-6 border-b pb-4">
            ...
            <h2 className="text-xl font-bold text-gray-800">Awaiting Results</h2>
          </div>
